...
WORKDIR /web
ARG CACHE_BUST=20250916-1245-STRUCTURAL-FIX
RUN echo "CACHE_BUST=${CACHE_BUST}" && echo "STRUCTURAL_JSON_PARSING_FIX=${CACHE_BUST}"
...
ARG CACHE_BUST=20250916-1245-STRUCTURAL-FIX
RUN echo "PYTHON_CACHE_BUST=${CACHE_BUST}" && echo "STRUCTURAL_JSON_PARSING_FIX=${CACHE_BUST}"
WORKDIR /app
