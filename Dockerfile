...
WORKDIR /web
ARG CACHE_BUST=20250916-1305-CRITICAL-FIX
RUN echo "CACHE_BUST=${CACHE_BUST}" && echo "CRITICAL_JSON_CRASH_FIX=${CACHE_BUST}"
...
ARG CACHE_BUST=20250916-1305-CRITICAL-FIX
RUN echo "PYTHON_CACHE_BUST=${CACHE_BUST}" && echo "CRITICAL_JSON_CRASH_FIX=${CACHE_BUST}"
WORKDIR /app
